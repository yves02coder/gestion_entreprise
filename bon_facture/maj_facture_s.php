                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <h3 class="card-title"> Facture de <?= $objet ?> </h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group ">
                                                    ...
                                                    <select class="form-control select2" id="fournisseur" name="fournisseur" required>
                                                  <?php
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="number" min="0" class="form-control" name="montant" id="montant"  required value="<?= intval($montant) ?>" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="text-center  py-4">
                                            <button type="submit" class="btn btn-primary mr-2" name="creer_facture_s" id="creer_facture_s">Enregistrer</button>
