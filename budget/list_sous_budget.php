...
$rubriques = s_list_budget(date('Y'));
...
<body>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
              ...
              Erreur SQL !!!
                ...
                Sous Ligne budgetaire enregistrée avec succès
                                ...
                                <tbody id='contenu'>
                                    ...
                                    foreach ($rubriques as $rubrique) {
                                        echo '<tr>  
                                            ...
                                            <td class="py-1"> <a href="update.php?id=' . $rubrique['id_sous_ligne'] . '"><button class="btn btn-success btn-sm "><i class=" fa fa-edit "></i></button></a>';
                                            if (($_SESSION['role'] != 'commercial') && ($_SESSION['role'] != 'comptable')) {
                                                echo' <a href="valide_sous_budget.php?id='.$rubrique['id_sous_ligne'].'"><button class="btn btn-success btn-sm "><i class=" fa fa-check "></i> Valider </button></a> ';}
                                           
                                            echo'<button class="btn btn-danger  btn-sm" onclick="confirmer(' . $rubrique['id_sous_ligne'] . ')"><i class="fa fa-trash"></i></button>
                                            </tr>';
                                        $i++;
                                    }
    ...
    <script type="text/javascript">
        ...
        $('#rubrique').change(function() {
            rubriquesb = $('#rubrique option:selected').val();
            annee_rubrique = $('#anneeb option:selected').val();
            $.ajax({
                type: 'POST',
                url: 'ajax.php',
                data: {
                    rubriquesb: rubriquesb,
                    annee_rubrique: annee_rubrique
                },
                success: function(rep) {
                    $('#contenu').html(rep)
                }
