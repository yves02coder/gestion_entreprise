...
if((!isset($_SESSION['connexion'])) || ($_SESSION['connexion']!='ok')){
   ...
   include_once('../partials/header.php');
    ...
    $lignes=sous_ligne_budget($_GET['id']);
    foreach($lignes as $ligne){
        $annee= $ligne['annee'];
        $libelle= $ligne['libelle_rubrique'];
        $libelle_s= $ligne['libelle_sous'];
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-8">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Validation S/ligne budgetaire</h6>
                            <form method="POST">
                            ...
                            <div class="col-sm-8">
                                    <input type="text" class="form-control" disabled value="<?=$libelle_s?>">
                                    </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary mr-2" name="valider_sligne" id="valider_sligne">Valider</button>                       
                             </div>
                    </form>
                  </div>
                </div>
