...
<div class="col-md-8">
            ...
            <div class="card card-warning">
              ...
              <form>
                ...
                <div class="row mb-3">
                  <label for="code" class="col-sm-4 col-form-label">Code Activité*</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="code" name="code" required placeholder="Code activité">
                  </div>
                </div>
                ...
                <div class="text-center  py-2">
                  <button type="submit" class="btn btn-warning mr-2" name="creer_rubrique" id="creer_rubrique">Enregistrer</button>
