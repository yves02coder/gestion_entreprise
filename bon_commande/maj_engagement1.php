                            ...
                            <div class="card card-warning">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST">
                                        ...
                                        <button class="btn btn-danger btn-sm" name="btn_supprime1" id="btn_supprime1" ><i class="fa fa-trash"></i></button>
                                        ...
                                        foreach ($produits as $produit) {
                                            ...
                                            <div class="row" id="ligne_produit' . $_GET['id'] . '' . $produit['id_produit_commande'] . '">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="py-1 ">
                                                          <button class="btn btn-danger btn-sm" name="btn_supprime' . $_GET['id'] . '' . $produit['id_produit_commande'] . '" id="btn_supprime' . $_GET['id'] . '' . $produit['id_produit_commande'] . '" onclick="supprime_produit()"><i class="fa fa-trash"></i></button>
                                                    </div>
                                                </div>
                                                </div>
                                        ...
                                        <hr>
                                        <h6 class="mb-4">Ajout de produit </h6>
                                        <div id="zone_produit">
                                        <button class="btn btn-success btn-sm btnaddligne" name="btnaddligne" id="btnaddligne" onclick="ajout(this.id)"><i class="fa fa-plus"></i></button>
                                            <input type="text"  class="form_control" name="exemple" id="exemple">
                                        </div>
