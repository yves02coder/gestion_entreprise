                                ...
                                <form method="POST">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="code" name="code" required placeholder="Code produit">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" id="prix" name="prix" required placeholder="0">
                                            </div>
                                        </div>


                                        <div class="text-center  py-2">
                                            <button type="submit" class="btn btn-warning mr-2" name="creer_produit" id="creer_produit">Enregistrer</button>
