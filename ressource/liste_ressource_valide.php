...
$sressources = liste_ressource_valide();
...
foreach ($sressources as $sressource) {
  $output .= '  <tr>
            ...
            if($_SESSION['role']!='comptable'){
              $output .= ' <a href="maj_ligne_ressource.php?id=' . $sressource['id_ligne_ressource'] . '"><button class="btn btn-success  btn-sm"><i class=" fa fa-edit "></i></button></a> 
               <button class="btn btn-danger  btn-sm" onclick="confirmer(' . $sressource['id_ligne_ressource'] . ')"><i class="fa fa-trash"></i></button>';
            }
            $output .= '</td>
           </tr>  ';
  $i++;
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Liste des lignes ressources validées</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <?php echo $output; ?>
