...
<body class="hold-transition sidebar-mini layout-navbar-fixed layout-fixed">
    <div class="wrapper">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <h3 class="card-title">Nouvelle S/Ressource</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="compte" name="compte" min="0" required >
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control select2" id="ressource" name="ressource" required>
                                                  ...
                                                  foreach($ressources as $ressource){
                                                    echo'<option value="'.$ressource['id_ressource'].'">'.$ressource['code_ressource'].':'.$ressource['libelle_ressource'].'</option>';
                                                  }
                                                  ?> 
                                                </select>
                                            </div>
                                        ...
                                        <div class="text-center  py-2">
                                            <button type="submit" class="btn btn-warning mr-2" name="creer_sressource" id="creer_sressource">Enregistrer</button>
     ...
     if(msg==1){$(function() {
      toastr.error('Ce compte existe déjà.')
    });
     } 
