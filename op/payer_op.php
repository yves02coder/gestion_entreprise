                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row ">
                                    <div class="col-12">
                                        <div class="bg-secondary rounded h-100 ">
                                            ...
                                            <iframe src="../documents/facture/<?= $facture ?>" width="100%" height="800px"></iframe>
                                ...
                                <div class="text-center  py-4">
                                    <button type="submit" class="btn btn-primary mr-2" name="payer_op" id="payer_op">Payer</button>
