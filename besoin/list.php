...
if((!isset($_SESSION['connexion'])) || ($_SESSION['connexion']!='ok')){
   ...
   $output.='  <tr>
                ...
                <a href="#?id='.$besoin['id_besoin'].'"><button class="btn btn-success btn-sm "><i class=" fa fa-edit "></i></button></a>';
                if (($_SESSION['role'] != 'commercial') && ($_SESSION['role'] != 'comptable')) {
                  $output.=' <a href="valide.php?id='.$besoin['id_besoin'].'"><button class="btn btn-success btn-sm "><i class=" fa fa-check "></i> Valider</button></a>';
                }
        ...
        <!-- partial -->
                      ...
                      <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Liste des besoins en attente</h6>
