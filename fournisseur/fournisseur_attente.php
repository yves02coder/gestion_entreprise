...
$fournisseurs = fournisseur_attente();
...
foreach ($fournisseurs as $fournisseur) {
  $output .= '  <tr>
            ...
            <td class=""> <a href="maj_fournisseur.php?id=' . $fournisseur['id_fournisseur'] . '"><button class="btn btn-success  btn-sm"><i class=" fa fa-edit "></i></button></a> ';
            if ($_SESSION['role'] !='comptable') {
              $output .= '<button class="btn btn-primary  btn-sm"  onclick="confirmer(' . $fournisseur['id_fournisseur'] . ')"><i class="fa fa-check"></i></button>';
            }
            $output .= '       
                      <button class="btn btn-danger  btn-sm" onclick="confirmer2(' . $fournisseur['id_fournisseur'] . ')"><i class="fa fa-trash"></i></button>
                      </td>  
...
<body class="hold-transition sidebar-mini layout-navbar-fixed layout-fixed">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Liste des fournisseurs en attente</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
  ...
  <script>
    ...
    $("#example1").DataTable({
     ...
     if(msg==1){$(function() {
      toastr.success('Fournisseur enregistré avec succès.')
    });
     }
     if(msg==2){$(function() {
     ...
     if(msg==3){$(function() {
      toastr.success('Fournisseur validé avec succès.')
    });
     }
     if(msg==4){$(function() {
