...
foreach ($fproformas as $fproforma) {
  $output .= '  <tr>
            ...
            $output .= '<a href="maj_fproforma.php?id='. $fproforma['id_fproforma'] .'"><button class="btn btn-success  btn-sm"><i class=" fa fa-edit "></i></button></a> ';
             }
             if($_SESSION['role']=='admin'){
              $output .= '<button class="btn btn-danger  btn-sm" onclick="confirmer(' . $fproforma['id_fproforma'] . ')"><i class="fa fa-trash"></i></button> ';
              }
              $output .= '</td>
           </tr>  ';
