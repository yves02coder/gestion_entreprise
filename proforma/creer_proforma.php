...
require('../configuration/proformaController.php');
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <h3 class="card-title"> Nouvelle proforma</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST">
                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <select class="form-control select2" name="client" id="client" required>
                                                            <option value="-1" selected disabled>-------Selectionner client------</option>
                                                            <?php
                                        ...
                                        <div class="text-center  py-2">
                                            <button type="submit" class="btn btn-warning mr-2" name="creer_proforma" id="creer_proforma">Enregistrer</button>
