...
foreach ($proformas as $proforma) {
  ...
  if ($_SESSION['role'] != "commercial") {
    $output .= '  <a href="#?id=' . $proforma['num_proforma'] . '"><button class="btn btn-success btn-sm"><i class=" fa fa-edit "></i></button></a> 
                 <button class="btn btn-danger  btn-sm" onclick="confirmer(' . $proforma['num_proforma'] . ')"><i class="fa fa-trash"></i></button> ';
  }
  $output .= ' </td></tr> ';
  $i++;
}
