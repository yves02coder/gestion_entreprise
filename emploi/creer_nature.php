                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <h3 class="card-title">Nouvelle nature économique</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            <label for="code" class="col-sm-4 col-form-label">Code Nature*</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="code" name="code" required placeholder="Code nature">
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center  py-2">
                                            <button type="submit" class="btn btn-warning mr-2" name="creer_nature" id="creer_nature">Enregistrer</button>
