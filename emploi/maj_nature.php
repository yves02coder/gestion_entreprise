...
$natures=getElementByID('natures','id_nature',$_GET['id']);
foreach($natures as $nature){
    $code=$nature['code_nature'];
    $libelle=$nature['libelle_nature'];
}
?>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <h3 class="card-title">Mise à jour nature</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center  py-2">
                                            <button type="submit" class="btn btn-success mr-2" name="maj_nature" id="maj_nature">Mise à jour</button>
